...
namespace ATTA_Prep_Course_Class_1_Notes
// program name
{
    class Program
    // Class
...

    {
       ...
       // This is where the program starts excution
        ...
        // var - an unspecified type that must be deduced by the compiler
            ...
            //Console.WriteLine("Hello World! "); // This is the Hello World program, because it has you start.
